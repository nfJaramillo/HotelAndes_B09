 ...
 * Proyecto: PersistenciaHotelAndesUniandes
 * @version 1.0
 * @author Germán Bravo
 * Julio de 2018
 * 
...
import uniandes.isis2304.parranderos.*;
import uniandes.isis2304.parranderos.persistencia.PersistenciaHotelAndes;

/**
 * Clase con los métdos de prueba de funcionalidad sobre PersistenciaHotelAndes
 * @author Germán Bravo
...
public class HotelAndesTest
{
	 ...
	 *****************************************************************/
	/**
	 * Ruta a la carpeta con los archivos necesarios
	 */
	private final static String CARPETA_CONFIG = "." + File.separator + "src" + File.separator + "main" + File.separator + "resources" + File.separator + "config" + File.separator;
	 ...
	 */
	private static final String CONFIG_TABLAS_A = CARPETA_CONFIG + "TablasBD_A.json"; 
	 ...
	 */
    private PersistenciaHotelAndes hotelAndes;
	...
	public void CRDTipoBebidaTest() 
	{
		...
		try
		{
			...
			hotelAndes = new PersistenciaHotelAndes( openConfig (CONFIG_TABLAS_A) );
		}
		catch (Exception e)
		{
...
//			e.printStackTrace();
		...
		{
			hotelAndes.limpiarPersistenciaHotelAndes();
